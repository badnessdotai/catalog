    ...
    <article className="mx-auto max-w-screen-lg">
      ...
      <div className="flex flex-col lg:flex-row items-start mt-12 lg:mt-24 gap-12">
        ...
        <div className="flex-1 w-full mt-12 lg:mt-0 min-w-0">
          <div
            className="prose prose-stone dark:prose-invert text-xl lg:text-2xl text-black dark:text-white mb-2"
                  ...
                  entry.sources.map(async (c) => {
                    ...
                    return (
                      <a key={c} href={url.href} className="block max-w-full">
                        <div className="text-black dark:text-white flex flex-row overflow-y-hidden items-baseline h-[1.3em]">
