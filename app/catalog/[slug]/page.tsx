            ...
            <div className="bg-gray-200 border-t-4 border-gray-500 rounded-b text-gray-900 px-4 py-3 shadow-md mt-16" role="alert">
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="text-sm">This means it was produced to demonstrate a real-world harm; although there was no actual harm caused in this setting, the example exhibits a potential risk.</p>
                </div>
              </div>
            </div>
          )}
